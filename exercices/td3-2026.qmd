...
1. Si $\alpha\geq 1$, vérifier que pour $u>0$, $n \in \mathbb{N}\setminus \{0\}$, $0 \leq n, n \ln \left(1 + \left(\frac{u}{n}\right)^\alpha\right)\leq \alpha u$. 
...
2. Si $\alpha<1$, utiliser le théorème de Fatou pour vérifier que la limite vaut $\infty$.
:::
...
::: {.callout-note name="Definitions" appearance="minimal"}
...
*Remarque:* Si $N=0$, on convient de $\max_{i\leq N} X_i = z$ avec $z \in [0,1]$ à choisir. 

i. Proposer un espace probabilisé pour modéliser l'énoncé. 
i. Calculer la fonction de répartition de la loi de $Z$. La fonction de répartition est-elle continue sur $\mathbb{R}$? La loi de $Z$ est-elle *diffuse*?
