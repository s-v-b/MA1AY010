...
### Exercice `r cnt_exo` (transformation affine)
...
::: {.content-visible when-profile="corrige"}
...
### Exercice `r cnt_exo`  (Minimum, maximum de variables indépendantes)
...
1. Soit $\phi : \mathbb{R} \to \mathbb{R}_+$ borélienne
    ...
    & =  \mathbb{E}[\phi(Y) \mathbf{1}_{\{\varepsilon}] + \mathbb{E}[\phi(-Y) \mathbf{1}_{\{\varepsilon}}]  \\ 
