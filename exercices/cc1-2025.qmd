...
Conditionnellement à $V=v$, les $Y_i$ sont indépendants (forment une famille indépendante). Mais la loi marginale de $Y_i$ n'est pas
une loi *produit*. Les $Y_i$ forment une famille *échangeable* mais pas une famille indépendante.  
...
On ne peut pas affirmer que la loi de $Y$ est absolument continue parce $\cos$ est continue et parce que la loi de $X$ est absolument continue.
Une fonction constante est continue mais l'image d'une loi absolument continue par une fonction constante est une loi de Dirac, qui n'est pas absolument continue.
