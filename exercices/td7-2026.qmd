...
## Fonctions génératrices : lois composées


::: {.callout-note name="Distributions composées" appearance="minimal"}

Une distribution composée est définie par une loi $P$ sur $\mathbb{N}$ et une distribution $Q$ sur $\mathbb{R}$. On considère l'univers $\Omega = \mathbb{N} \times \mathbb{R}^{\mathbb{N}}$. L'univers est muni 
de la tribu produit $\sigma \left(\mathcal{P}(\mathbb{N}) \times \mathcal{C} \right)$ où $\mathcal{C}$ est la tribu des cylindres $\sigma\left( \cup_k \mathcal{B}(\mathbb{R}^k) \right)$. 
...
## Fonctions génératrices, régularité et intégrabilité
